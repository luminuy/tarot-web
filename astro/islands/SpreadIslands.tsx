 ...
 *
 * ⚠️ `PUBLIC_SPREADS` ถูกนำเข้าที่นี่เฉพาะสำหรับหน้ารวม (`/spreads`) ซึ่งแสดงผังทั้ง 26 แบบอยู่แล้ว
 ...
 *    แล้วเจอ 404 · แถบหมวด "ผังทั้งหมด" ยังขึ้นเลข 28 ขัดกับหัวข้อ "25 รูปแบบ" (ตอนนั้นมี 25 ผัง) ของหน้าเดียวกัน
 */
