...
```bash
# ✅ รัน Verification Suite ทั้ง 43 ด่านในคำสั่งเดียว (ใช้ตัวนี้เป็นหลัก)
...
4. **พิสูจน์ว่าแก้ได้จริง (Verify, don't assume)** — ทดสอบทั้งเส้นทางที่สำเร็จและที่ล้มเหลว (43/43 verification gates)
...
7. **ทำงานให้สะอาดและจบสมบูรณ์ 100% (Zero Leftovers)** — ตรวจ 43 ด่าน ➔ Commit ➔ Push ➔ Auto-Merge ➔ Tidy ห้ามทิ้งภาระให้ผู้อื่นตามแก้
