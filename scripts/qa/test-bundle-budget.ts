...
export const BUDGETS: RouteBudget[] = [
  ...
  },
  {
     ...
     *    ห้ามขยับขึ้นเพื่อให้ผ่าน ให้ไปลดของจริงก่อนเสมอ
     *
     * 📌 ของหนักที่รู้ตัวอยู่: คลังคำอ่านที่เขียนไว้ล่วงหน้าของทั้ง 8 หัวข้อ (ไทย+อังกฤษ)
     *    ถูกลากเข้าบันเดิลตั้งแต่เปิดหน้า ทั้งที่ใช้เป็น "บทเสริม" หลังเปิดกองแล้วเท่านั้น
     *    แยกออกเป็น chunk แยกได้ในอนาคต (ISSUE-050 ใน KNOWN_ISSUES)
     */
    maxJsGzipKb: 158, // dev วัดได้ 143 KB · เผื่อส่วนต่าง CI ~9 KB + ระยะหายใจ
