...
const ALLOWLIST: { file: string; needle: string; reason: string }[] = [
  {
    ...
    reason:
      "`.card-tile-cv` (กริดไพ่ 78 ใบ) — แก้ต้นเหตุของ INC-0174 ครบทั้งสองข้อแล้ว: การ์ดทุกใบสูงเท่ากัน " +
      "(ล็อกแถวคีย์เวิร์ดไว้ 2 บรรทัด) และความสูงที่จองไว้คำนวณจากความกว้างจอด้วย calc(vw) ต่อ breakpoint " +
      "จากตัวเลขที่วัดจริง 18 ความกว้างจอ · ด่าน scripts/qa/test-card-tile-height.ts วัดซ้ำทุกครั้งที่ CI รัน " +
      "· กำไรที่ได้กลับมา: /cards TBT ~4,200 ms ➔ ระดับ 200 ms โดยกระตุก 0 ครั้ง",
  },
