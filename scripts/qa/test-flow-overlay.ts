...
if (!fs.existsSync(FLOW)) {
   ...
   * เริ่มต้นที่ 37 (รอบตรวจ 2026-09-17) · ยุบกลุ่มหน้าต่างลอยแล้วเหลือ 28
   * ยุบกลุ่มถัดไป (สำรับ/สตรีม/provably-fair) เมื่อไหร่ ให้ลดตัวเลขนี้ตามทันที
   */
  const USE_STATE_BUDGET = 28;
  check(
