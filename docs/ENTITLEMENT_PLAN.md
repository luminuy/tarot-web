...
> ⚠️ **ค้างตรวจ — ระบบเปิดใช้แล้วแต่ยังไม่ยืนยันว่าทำ 2 ขั้นนี้ครบก่อนเปิด**
> การเปิดธงคือ **การลดสิทธิ์ผู้ใช้เดิม** ที่เคยเปิดไพ่ได้ไม่จำกัด · runbook เดิมกำหนดให้ทำก่อน:
> 1. **โบนัสเปลี่ยนผ่าน 10 ครั้ง** แก่ผู้ใช้ที่สมัครก่อนวันเปิด — รันแล้วหรือยัง?
> 2. **แบนเนอร์ประกาศล่วงหน้า 7 วัน** — เคยเปิดครบ 7 วันก่อนเปิดจริงไหม?
>
> ตรวจที่ `/admin` → แท็บ "สิทธิ์เปิดไพ่" · ถ้ายังไม่ได้ทำ ผู้ใช้เดิมจะเจอสิทธิ์ถูกตัดโดยไม่มีการแจ้ง
> — พิจารณาให้โบนัสย้อนหลังทันทีเพื่อชดเชย
