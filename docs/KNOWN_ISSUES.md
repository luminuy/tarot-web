...
| :-- | :-- | :--- | :--- | :-- |
| **049** | 🟡 Open | **ผลตรวจรอบ 2 — เหลือลูกบิดเดียวที่อยู่นอกรีโป (Early Hints)** | `astro/layouts/BaseLayout.astro` (สไตล์ชีตก้อนเดียว) | 🟡 **รอเจ้าของกดสวิตช์ (2026-09-17)** — ✅ ข้อ 9 · R-26 · R-31 · R-10 ปิดครบ · ✅ **R-02 ปิดแล้ว วัดบน production จริง**: `/spreads` TBT ของโค้ดเราเอง **701 ➔ 72–107 ms** · perf 67 ➔ **96** (เลิก hydrate คลังผัง · JS −24.3 KB gzip) · 🟡 เหลือ **R-11/R-12 = สไตล์ชีตก้อนเดียวถ่วงเรนเดอร์ 100–400 ms** ซึ่งตรวจซ้ำแล้วไม่มีไขมันให้ตัดในโค้ด ➔ **ทางเดียวคือเปิด Early Hints ที่ Cloudflare Dashboard** (เครื่องนี้ไม่มีสิทธิ์แก้ค่าโซน) |
