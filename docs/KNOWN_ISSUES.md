...
⚠️ **สิ่งที่ยังวัดไม่ได้ในรอบนี้**: ผลของ Early Hints ต่อ FCP/LCP ต้องวัดหลัง deploy รอบถัดไป
และ Lighthouse แบบ `simulate` มัก **ไม่สะท้อน** ประโยชน์ของ 103 (มันจำลองเครือข่ายเอง)
ตัวเลขจริงต้องดูจาก CrUX / PSI ภาคสนามเมื่อข้อมูลสะสมพอ
