...
| :-- | :-- | :--- | :--- | :-- |
| **032** | 🔵 Low | ยังไม่มีใครเดินพิธีกรรมครบขั้นบนผังใหม่ทั้ง 5 และยังไม่จับภาพมือถือ 320/375px | `src/data/spreads.ts`, `src/components/spread/SpreadBoard.tsx` | 🔴 **ยังไม่ตรวจ** — เกณฑ์ผ่านคลื่น 3 ที่ค้างอยู่ · แผนงาน A ใน [`HANDOFF_QA_SPREADS_2026-09-06.md`](plans/HANDOFF_QA_SPREADS_2026-09-06.md) |
...
## 🔵 ระดับ Low — พบจากการตรวจรับคลื่น SEO 2–4 เมื่อ 2026-09-06 (ยังไม่ได้ตรวจ)

> 📦 **ขั้นตอนทดสอบและเกณฑ์ผ่านอยู่ที่ [`docs/plans/HANDOFF_QA_SPREADS_2026-09-06.md`](plans/HANDOFF_QA_SPREADS_2026-09-06.md) งาน A** — อ่านที่นั่นก่อนลงมือ

### ISSUE-032 · ผังใหม่ทั้ง 5 ยังไม่เคยถูกใช้งานจริงสักครั้ง
...
| **ความเสี่ยงจริง** | ถ้าล้นจริงจะกระทบผู้ใช้มือถือซึ่งเป็นสัดส่วนหลักของเว็บ และเป็นหน้าที่ตั้งใจดึงทราฟฟิกจาก Google โดยเฉพาะ |
