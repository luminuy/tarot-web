...
| :-- | :-- | :--- | :--- | :-- |
| **048** | 🔵 Low | **หน้า `/cards` แลกความเร็วไปกับความนิ่ง — ถอด `content-visibility` ออกแล้วจอไม่กระตุกอีก แต่ style&layout โตขึ้นเท่าตัว** | `src/components/encyclopedia/CardsExplorer.tsx`, `src/components/encyclopedia/CardGroupView.tsx` | 🟡 **เปิดไว้ตั้งใจ (2026-09-15)** — วัดบนบิลด์เดียวกันสองชุด (มือถือ · simulate · หน้าละ 2 รอบ): เปิด `content-visibility` ไว้ TBT **78–94 ms** · style&layout **822–875 ms** · perf 71–77 แต่ **จอกระตุก 14 ครั้ง · CLS 0.766** · ถอดออก **กระตุก 0 ครั้ง · CLS 0** แต่ TBT **1,522–1,546 ms** · style&layout **1,874–2,081 ms** · perf 52 · **เลือกความนิ่งเพราะ CLS เป็น Core Web Vital จริงที่ Google ใช้จัดอันดับ ส่วน TBT เป็นค่าห้องแล็บ** และผู้ใช้เห็นอาการกระตุกด้วยตาเปล่า (เจ้าของแจ้งเองเมื่อ 2026-09-15) · **ทางแก้ถาวรที่ยังไม่ได้ทำ**: ทำให้ความสูงการ์ดผูกกับความกว้างด้วย `aspect-ratio` แล้วค่อยเอา `content-visibility` กลับมา — ต้องหนีบชื่อไพ่ให้เหลือ 2 บรรทัดตายตัวก่อน (กระทบหน้าตา ต้องให้เจ้าของเคาะ) · ทางเลือกอื่นที่ไม่ต้องแตะดีไซน์: แบ่งหน้าแสดงทีละ 24 ใบ (แต่กระทบ SEO เพราะลิงก์ 78 เส้นจะไม่อยู่ใน HTML ครบ) · ⚠️ ที่ **ไม่ใช่** สาเหตุ (วัดแล้ว): `transform-gpu` บนการ์ด — ถอดออกแล้ว TBT ยังอยู่ที่ 1,378–3,861 ms เท่าเดิม |
