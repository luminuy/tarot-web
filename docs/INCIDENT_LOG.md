...
| **🛡️ กฎป้องกันถาวร** | **ห้ามต่อสตริง title/description เองแล้วเดาความยาวเด็ดขาด ต้องผ่าน pickTitle() และ clampDescription() เสมอ และด่านที่ 40 (test-meta-length.ts) จะวัดจาก HTML ที่ build ออกมาจริงทุกหน้า บล็อก PR ทันทีที่หน้าใดหน้าหนึ่งเกินเพดาน** |
