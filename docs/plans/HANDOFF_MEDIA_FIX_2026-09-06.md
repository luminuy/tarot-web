...
> **สถานะ**: 🟢 **ลงมือไปแล้ว 4/6 ข้อ** (อัปเดต 2026-09-06 หลัง PR #328 · #330)
...
> | **M-05** `CACHE_VERSION` ฮาร์ดโค้ด | ⬜ **ยังไม่ทำ** | `public/sw.js:11` ยังเป็น `"v1.0.0"` |
> | **M-06** `/api/search` กำพร้า | ⬜ **รอเจ้าของตัดสิน** | ไฟล์ยังอยู่ · ยังไม่มีใครเรียกจากหน้าเว็บ |
>
> ➔ ทีมที่รับไปทำต่อ **อ่านเฉพาะหัวข้อ 6 (M-05) และ 7 (M-06)** ก็พอ
> ส่วนที่เหลือเก็บไว้เป็นบันทึกว่าแก้อะไรไปแล้วและตรวจยังไง
>
