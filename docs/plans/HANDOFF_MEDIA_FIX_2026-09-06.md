...
> | **M-06** `/api/search` กำพร้า | ⬜ **รอเจ้าของตัดสิน** | ไฟล์ยังอยู่ · ยังไม่มีใครเรียกจากหน้าเว็บ (คุ้มครองโดยด่าน 24) |
>
> ➔ ทีมงานทำเสร็จครบทุกข้อด้านการพัฒนา (M-01 ถึง M-05) แล้ว เหลือเพียง **M-06** ที่ต้องรอคำตอบจากเจ้าของโปรเจกต์
>
