...
| รหัสแลกสิทธิ์ | ไม่ได้ออกแบบไว้ | **2 ชนิด: `gift_*` (รอบเปิดไพ่) · `purchase_*` (ปลดพรีเมียม)** ออกจาก `/admin` เท่านั้น | 2026-09-12 (INC-0132): รหัสที่ seed ไว้ในรีโปแลกได้ไม่จำกัดคนและทำให้ทุกคนเป็นลูกค้าที่จ่ายเงิน · ตอนนี้บังคับเพดานจำนวนคน + วันหมดอายุทุกใบ |
