...
2. ⬜ **เตรียมฐานข้อมูล** → กดปุ่ม (สร้างตารางบน D1 · idempotent · แสดง ✓ พร้อม)
   **ยืนยันข้อนี้ก่อนเป็นอันดับแรก** — ถ้าตาราง `reading_usage` / `user_bonus` ยังไม่ถูกสร้างบน prod
   การหักสิทธิ์จะล้มเงียบ (โค้ดจับ error แบบ best-effort) แล้วทุกคนจะใช้ได้ไม่จำกัดโดยไม่มีใครรู้
