...
>
> ⚠️ **ความเสี่ยงที่ตรวจแล้วว่าไม่เกิด แต่ต้องระวังในอนาคต:** ถ้าตารางไม่ถูกสร้าง
> `consumeReading()` จะจับ error แบบ best-effort แล้วคืน `true` → ทุกคนใช้ได้ไม่จำกัด
> **โดยไม่มี error ให้เห็น** · ถ้าอนาคตย้าย D1 หรือสร้างฐานข้อมูลใหม่ ต้องกลับมากดปุ่มนี้อีกครั้ง
