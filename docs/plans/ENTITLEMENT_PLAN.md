...
> **โควตาสมาชิก:** **3 ครั้ง/วัน** (เปลี่ยนจาก 3 ครั้ง/สัปดาห์ — ดู [§0 บันทึกการเปลี่ยนสเปก](#0-บันทึกการเปลี่ยนสเปก))

---

## 0. บันทึกการเปลี่ยนสเปก

เอกสารนี้เขียนตอนออกแบบ (3 ครั้ง/**สัปดาห์**) แต่ของจริงที่ปล่อยไปแล้วเป็น 3 ครั้ง/**วัน**
...
| :--- | :--- | :--- | :--- |
| โควตาสมาชิก | 3 / สัปดาห์ | **3 / วัน** (`DAILY_LIMIT`) | 3/สัปดาห์ สร้างนิสัยรายวันไม่ได้ · คนใหม่ใช้ 3 ครั้งรวดวันแรกแล้วรอ 6 วัน = วันที่ตั้งใจสูงสุดกลับเจอกำแพง |
| รอบรีเซ็ต | จันทร์ 00:00 ไทย | **เที่ยงคืนทุกวัน เวลาไทย** | ตามข้อบน |
| ไพ่ประจำวัน | ไม่ได้ออกแบบแยก | **ฟรี ไม่กินโควตา + มี streak** (`lib/entitlement/daily.ts`) | เปิดไพ่วันละใบเป็นธรรมเนียมทาโรต์ที่ถูกต้อง (ต่างจากถามซ้ำเรื่องเดิม) · เป็นตัวสร้างนิสัยโดยไม่ต้องปล่อยผังใหญ่ให้ฟรี |
...
**เพดานรองรับที่ `AI_DAILY_CALL_CAP = 2000`:** 3/วัน ≈ 660 สมาชิกถ้าใช้เต็มทุกคน
(~2,600 ถ้าใช้จริงราว 25%) · **ถ้าชนเพดาน ทุกคนถูกบล็อกรวมถึงผู้เยี่ยมชมที่กำลังจะสมัคร**
