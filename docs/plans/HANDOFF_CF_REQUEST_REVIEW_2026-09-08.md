...
> **สถานะ**: 📚 เอกสารอ้างอิง — บันทึกการตัดสินใจรายข้อ — ข้อที่เป็นโค้ดทำแล้ว · ข้อที่เป็นสวิตช์ Cloudflare เป็นของเจ้าของ · **ตรวจล่าสุด**: 2026-09-23
> **อ่านก่อนแตะ**: การตั้งค่า Cloudflare — ข้อเสนอที่ห้ามทำ 5 ข้อ (เช่น Block AI Scrapers)
