...
> **สถานะ**: 🚧 ทำแล้วบางส่วน — ลงมือแล้วส่วนใหญ่ — เงาแยกชั้น · View Transition · สำรับออกจากบันเดิล (#338 · #345) · content-visibility ใช้ได้เฉพาะกริดไพ่ (INC-0174 · HANDOFF_CARD_TILE_CV) · ข้อ S-03 (ไพ่ 80 ใบใน DOM) ยังไม่ได้ตรวจยืนยัน · **ตรวจล่าสุด**: 2026-09-23 · **หลักฐาน**: PR #338 · #345
