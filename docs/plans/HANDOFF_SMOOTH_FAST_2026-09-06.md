...
> **สถานะ**: ✅ เสร็จแล้ว — เงาแยกชั้น · View Transition · สำรับออกจากบันเดิล (#338 · #345) · S-03 ปิดด้วย `card-tile-cv` (ไพ่ครบ 78 ใบใน HTML ตามข้อห้าม SEO แต่ข้ามการวาดนอกจอ — `/cards` TBT ~4,000 ➔ ~100 ms · HANDOFF_CARD_TILE_CV) · **ตรวจล่าสุด**: 2026-09-23 · **หลักฐาน**: PR #338 · #345 · `src/components/encyclopedia/CardsExplorer.tsx` · `CardGroupView.tsx`
