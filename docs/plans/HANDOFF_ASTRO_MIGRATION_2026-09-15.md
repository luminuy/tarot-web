...
> คลื่นที่ 3 เสร็จแล้ว (`/about` · `/privacy` · `/contact` ทั้งสองภาษา)
> **รวมตอนนี้: Astro 297 หน้า · Next เหลือ 14 หน้า** = หน้าแรก + หน้าแอปตามที่เจ้าของสั่งให้คงเป็น React island
