...
> **สถานะ**: คลื่นที่ 1 ขึ้น production แล้ว (`/cards/**` 174 หน้า) · คลื่นที่ 2 เสร็จแล้ว (`/blog/**` + `/spreads/**`)
> คลื่นที่ 3 เสร็จแล้ว (`/about` · `/privacy` · `/contact`) · คลื่นที่ 4 เสร็จแล้วเฉพาะหน้าสาธารณะ
> (`/reading/chat` · `/daily` · `/love/1-card` · **หน้าแรก**) ตามที่เจ้าของเลือก
> **รวมตอนนี้: Astro 305 หน้า · Next เหลือ 6 หน้า** — เหลือเฉพาะหน้าที่ต้องล็อกอิน/หลังบ้าน
> (`/account` · `/admin` · `/admin/login` · `/reset-password` · `/tester` · `/readers/console`)
> ซึ่งเจ้าของสั่งให้คงไว้กับ Next เพราะไม่มีผลกับ SEO และความเร็วผู้ใช้ทั่วไป
