...
| คำสั่ง | วัตถุประสงค์ |
| :--- | :--- |
| `npm run repo:verify` | **(สำคัญที่สุด)** รันชุดตรวจความสมบูรณ์ 33 ด่าน (Typecheck, ไพ่ 78 ใบ, ผัง 25 แบบ, Provably Fair, Agent Lock ฯลฯ) |
...
| `npm run pr:auto` | ตรวจ 33 ด่าน ➔ Push ➔ สร้าง PR ➔ Auto-Merge ➔ Deploy อัตโนมัติ |
