...
**ผลตรวจ**: `typecheck` 0 error · `repo:verify` **ผ่านครบ 51/51 ด่าน** · ทดสอบจริงบน dev: ไม่มี header → **401 ตัวเปล่า** · secret ผิด → **401** · secret ถูก → **200** พร้อมสรุป `{scanned, sent, skipped, failed}` · สมัครจริง 1 คนแล้วยิง → **sent = 1** พร้อมอีเมลที่มีชื่อไพ่ คำสำคัญ คำทำนาย และ SHA-256 ครบ · **ยิงซ้ำวันเดียวกัน → scanned = 0, sent = 0** · โทเคนยกเลิกถูกแก้มือ → **400** · กดลิงก์ยกเลิกจริงโดยไม่ล็อกอิน → **200 และหลุดจากคิวทันที**
