...
และ **เอากฎจริงไปวิ่งผ่าน Lightning CSS ตัวเดียวกับที่ build ใช้ แล้วยืนยันว่าผลลัพธ์ยังมี transform 3 มิติ**
...
- ทดสอบด่านด้วยการทำให้พังจริง 3 เคส (ย้อนไป `translate3d(0,0,0)` · ถอดโล่ · ไม่เหลือ 3D เลย) จับได้ครบ
