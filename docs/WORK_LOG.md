...
- ⚠️ **ยังไม่มีตัวเลข Lighthouse หลัง deploy** — ต้องยิง `npm run perf:lh -- spreads` เทียบฐาน 926/701 ms
  (การวัดบนเครื่อง dev เชื่อไม่ได้: ยิงหน้าเดิมสามรอบได้ 769 · 1,560 · 1,826 ms)
