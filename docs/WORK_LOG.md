...
- **Quality Verification**: `npm run repo:verify` ➔ **✅ ผ่านครบทั้ง 43/43 ด่าน (สมบูรณ์ 100%)**
...
**ตรวจแล้ว**: `npm run repo:verify` ➔ ✅ **43/43 ด่าน** · `npm run typecheck` ➔ ✅ 0 errors ·
...
**ตรวจแล้ว**: `npm run repo:verify` ➔ ✅ **43/43 ด่าน** (รวมด่านที่เรนเดอร์จริง 41 จอ) ·
...
| `pr.yml` (ชื่อขั้นตอน) | `Verification Suite (6 ด่าน)` | 43 ด่าน |
| `pr.yml` (คอมเมนต์) | `ชุดตรวจกลาง 6 ด่าน ... ผัง 20 แบบ` | 43 ด่าน · 25 ผัง |
...
**ตรวจแล้ว**: `npm run repo:verify` ➔ ✅ 43/43 ด่าน · ทดสอบด่านด้วยการใส่เลขผิดกลับเข้า workflow แล้วจับได้จริง
...
- `npm run repo:verify` ➔ ✅ ผ่าน **43/43 ด่าน**
...
**ตรวจแล้ว**: `npm run repo:verify` ผ่าน **43/43 ด่าน** · `typecheck` 0 errors ·
