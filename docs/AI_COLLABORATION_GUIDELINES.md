...
8. **🖼️ กฎการจัดวางพรีวิวผังไพ่ (Spread Artwork Safe Bounds & Badge Pin Standard)**:
   - ในคอมโพเนนต์ `TarotArtIcons.tsx` พรีวิวผังที่มี **4 ใบขึ้นไป หรือมีการจัดวาง 2 ชั้นขึ้นไป ห้ามใส่ข้อความ string label ใต้การ์ดย่อยทุกใบเด็ดขาด!**
   - ให้ใช้ **Floating Badge Pin บนมุมการ์ดโดยตรง (เช่น `#1`, `#2`, `#3`, `#4`, `#5`)** เพื่อคุมความสูงรวมให้อยู่ระหว่าง **85px – 100px** ไม่ล้นออกจากคอนเทนเนอร์ และเว้นช่องว่าง Padding หายใจอย่างประณีต
