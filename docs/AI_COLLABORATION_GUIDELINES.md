...
# 7. เปิด PR (ระบบจะตรวจครบ 41 ด่านซ้ำ + merge + deploy ให้เอง)
...
8. **🖼️ กฎภาพพรีวิวผังไพ่ (100% Pure Artwork & Zero Text Overlay Standard)**:
   - ในคอมโพเนนต์ `TarotArtIcons.tsx` ภาพพรีวิวผังไพ่ทั้ง 25 แบบ **ต้องแสดงเฉพาะรูปภาพหน้าไพ่ 1909 Rider-Waite ดั้งเดิมล้วนๆ อย่างคมชัดและสง่างาม**
...
11. **💬 กฎการใช้ภาษาที่เป็นธรรมชาติและเข้าใจง่ายเหมือนมนุษย์ (Human-First Natural Copywriting Standard)**:
   ...
   - **✅ ใช้คำที่กระชับและเป็นมิตร**: เช่น **'เมนู'**, **'ผังการเปิดไพ่ (25 แบบ)'**, **'ความหมายไพ่ (78 ใบ)'**, **'ประวัติการดูดวง'**, **'เริ่มดูดวงใหม่'**
...
13. **🚀 Auto-Merge Workflow Enforcement (เปิด PR เสมอ)**:
   - เมื่อเปิด PR ให้ใช้ `npm run pr:auto` เสมอ เพื่อให้ CI ตรวจครบ 41 ด่าน ➔ Auto-Merge (Squash) ➔ Auto-Deploy Cloudflare Workers จบในคำสั่งเดียว
...
```bash
# ✅ คำสั่งเดียวจบ — ตรวจครบทั้ง 41 ด่านในรอบเดียว
