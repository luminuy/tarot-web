...
└── 📦 แผนพัฒนาตามหมุดหมาย (Milestone Plans Archive)
    └── plans/
        ...
        ├── HANDOFF_BLOG_TBT_2026-09-12.md    # ⚡ แผนหา TBT ที่หายไปของหน้า /blog (ISSUE-043) — รอทำ + 3 กับดักการวัด
        ├── HANDOFF_UX_UI_AUDIT_2026-09-11.md # 🔍 ผลตรวจ UX/UI ทั้งเว็บ 20 ข้อ — P0 ปิดครบ + มีด่านคุ้มกันแล้ว (#416) · เหลือ 17 ข้อ
...
| :--- | :--- |
| `npm run repo:verify` | **ตรวจครบทั้ง 50 ด่านในคำสั่งเดียว** (Typecheck, ไพ่ 78 ใบ, ผัง 25 แบบ, Provably-Fair, D1, Failover, PDPA ฯลฯ) |
...
| `npm run pr:auto` | ตรวจครบ 50 ด่าน ➔ Push ➔ เปิด PR ➔ Auto-Merge ➔ Deploy Cloudflare Workers ในคำสั่งเดียว |
