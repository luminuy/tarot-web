...
└── 📦 แผนพัฒนาตามหมุดหมาย (Milestone Plans Archive)
    └── plans/
        ...
        ├── HANDOFF_BLOG_TBT_2026-09-12.md    # ⚡ แผนหา TBT ที่หายไปของหน้า /blog (ISSUE-043) — แก้แล้วใน PR #453 · รอวัดผลยืนยัน + 4 กับดักการวัด
...
| :--- | :--- |
| `npm run repo:verify` | **ตรวจครบทั้ง 57 ด่านในคำสั่งเดียว** (Typecheck, ไพ่ 78 ใบ, ผัง 25 แบบ, Provably-Fair, D1, Failover, PDPA ฯลฯ) |
...
| `npm run pr:auto` | ตรวจครบ 57 ด่าน ➔ Push ➔ เปิด PR ➔ Auto-Merge ➔ Deploy Cloudflare Workers ในคำสั่งเดียว |
