...
| :--- | :--- |
| `npm run repo:verify` | **ตรวจครบทั้ง 37 ด่านในคำสั่งเดียว** (Typecheck, ไพ่ 78 ใบ, ผัง 25 แบบ, Provably-Fair, D1, Failover, PDPA ฯลฯ) |
...
| `npm run pr:auto` | ตรวจครบ 37 ด่าน ➔ Push ➔ เปิด PR ➔ Auto-Merge ➔ Deploy Cloudflare Workers ในคำสั่งเดียว |
