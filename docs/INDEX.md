...
└── 📦 แผนพัฒนาตามหมุดหมาย (Milestone Plans Archive)
    └── plans/
        ...
        ├── HANDOFF_OMNI_YESNO_2026-09-06.md    # 🎯 แผนส่งต่อ 3 งานจากบทวิเคราะห์คู่แข่งภายนอก — Yes/No 78 หน้า + Omnichannel + Daily Digest
...
| :--- | :--- |
| `npm run repo:verify` | **ตรวจครบทั้ง 33 ด่านในคำสั่งเดียว** (Typecheck, ไพ่ 78 ใบ, ผัง 25 แบบ, Provably-Fair, D1, Failover, PDPA ฯลฯ) |
...
| `npm run pr:auto` | ตรวจครบ 33 ด่าน ➔ Push ➔ เปิด PR ➔ Auto-Merge ➔ Deploy Cloudflare Workers ในคำสั่งเดียว |
