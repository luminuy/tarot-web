...
└── 📦 แผนพัฒนาตามหมุดหมาย (Milestone Plans Archive)
    └── plans/
        ...
        ├── HANDOFF_GLASS_HOME_2026-09-21.md # 🪟 ธีมกระจกอุ่น (Warm Liquid Glass) + หน้าแรก "ประตูเดียว" — ค่าคัดลอกไปวางได้ · ตารางคอนทราสต์ที่คำนวณแล้ว · กับดัก 7 ข้อ (รอทีมรับไปทำ)
...
| :--- | :--- |
| `npm run repo:verify` | **ตรวจครบทั้ง 80 ด่านในคำสั่งเดียว** (Typecheck, ไพ่ 78 ใบ, ผัง 25 แบบ, Provably-Fair, D1, Failover, PDPA ฯลฯ) |
...
| `npm run pr:auto` | ตรวจครบ 80 ด่าน ➔ Push ➔ เปิด PR ➔ Auto-Merge ➔ Deploy Cloudflare Workers ในคำสั่งเดียว |
