...
└── 📦 แผนพัฒนาตามหมุดหมาย (Milestone Plans Archive)
    └── plans/
        ...
        ├── AI_INTELLIGENCE_PLAN.md      # 🧠 แผนยกระดับความฉลาดแม่หมอ AI — กลยุทธ์ (ทำไม)
        ├── AI_INTELLIGENCE_EXECUTION.md # 🛠️ แผนลงมือ 8 งาน แบ่ง PR A-H พร้อมเกณฑ์ผ่านรายข้อ (ทำยังไง)
