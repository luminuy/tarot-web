...
| [docs/plans/HANDOFF_BLOG_TBT_2026-09-12.md](docs/plans/HANDOFF_BLOG_TBT_2026-09-12.md) | ⚡ **แผนหา TBT ที่หายไปของหน้า `/blog`** — งานเดียวที่ค้างจากรอบตรวจ SEO 2026-09-11 · Lighthouse ชี้ `/blog` TBT 660 ms แย่กว่าทุกหน้า 4.1 เท่า · ตัดผู้ต้องสงสัยไปแล้ว 6 ข้อ · มีขั้นตอนยิง `bootup-time` ชี้เป้าไฟล์ + **3 กับดักการวัดที่เหยียบมาแล้ว** (resource-summary นับแบบคลายบีบ · Browser pane วัดเวลาแกว่ง 8 เท่า · โควตา PSI หมดเร็ว) + สรุปเรื่อง AVIF ให้จบ |
...
13. **Auto-Merge Enforcement**: เปิด PR ต้องใช้ `npm run pr:auto` เสมอ เพื่อให้ CI ตรวจ 44 ด่าน ➔ Auto-Merge (Squash) ➔ Auto-Deploy Cloudflare Workers
...
- `npm run repo:verify` — ตรวจครบทั้ง 44 ด่าน (ใช้หลัก)
