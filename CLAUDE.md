...
13. **Auto-Merge Enforcement**: เปิด PR ต้องใช้ `npm run pr:auto` เสมอ เพื่อให้ CI ตรวจ 78 ด่าน ➔ Auto-Merge (Squash) ➔ Auto-Deploy Cloudflare Workers
...
- `npm run repo:verify` — ตรวจครบทั้ง 78 ด่าน (ใช้หลัก)
