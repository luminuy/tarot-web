...
| [docs/plans/HANDOFF_UX_UI_AUDIT_2026-09-11.md](docs/plans/HANDOFF_UX_UI_AUDIT_2026-09-11.md) | 🔍 **ผลตรวจ UX/UI ทั้งเว็บ + แผนส่งต่อ (2026-09-11)** — 20 ข้อ 4 ระดับ วัดจริงบน production ทุกตัวเลข · **P0 สามข้อ**: สายด่วนวิกฤต 1323/1669 คอนทราสต์ตก (3.11 · 2.81 vs เกณฑ์ 4.5) ขัดกฎเหล็กข้อ 6 · หน้าแรกไม่มี landmark `banner`/`contentinfo` เลย · `<h1>` เป็นหัวข้อลำดับที่ 6 · หนี้ที่วัดได้: สีฮาร์ดโค้ด 4,215 จุด/40 ค่า · `<Button>` กลางใช้แค่ 12/67 ไฟล์ · 17 ช่องกรอกไร้ label · 5/7 หน้าต่างไม่มี Esc/focus trap · 49 เส้นทางไม่มี `loading.tsx` · มีภาคผนวก "ตรวจแล้วผ่าน" กันรอบหน้าเสียเวลาซ้ำ |
