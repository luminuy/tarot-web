...
| [docs/plans/HANDOFF_DOCS_TRUTH_2026-09-06.md](docs/plans/HANDOFF_DOCS_TRUTH_2026-09-06.md) | 🧾 **แผนปิดหนี้หลังคลื่น 2–4** — ด่านตรวจเลขในเอกสารอัตโนมัติ · กวาดเลขค้าง 20 จุด · เติมบทนำให้ถึง 300 คำ · วัดผล GSC (งาน A/B/C ปิดแล้ว) |
| [docs/plans/HANDOFF_QA_SPREADS_2026-09-06.md](docs/plans/HANDOFF_QA_SPREADS_2026-09-06.md) | 🧪 **แผน QA ผังใหม่ทั้ง 5** — เดินพิธีกรรมจริง 320/375px · ทดสอบ guest · ปิดช่องโหว่ `guestAllowed` ที่ไม่มีผลบังคับ |
...
13. **Auto-Merge Enforcement**: เปิด PR ต้องใช้ `npm run pr:auto` เสมอ เพื่อให้ CI ตรวจ 33 ด่าน ➔ Auto-Merge (Squash) ➔ Auto-Deploy Cloudflare Workers
...
- `npm run repo:verify` — ตรวจครบทั้ง 33 ด่าน (ใช้หลัก)
