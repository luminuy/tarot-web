...
| ✅ | [✦ แผนทำให้เว็บ "สมูทและไว" ระดับโลก — ทุกหน้า ทุกจังหวะ (2026-09-06)](docs/plans/HANDOFF_SMOOTH_FAST_2026-09-06.md) | เงาแยกชั้น · View Transition · สำรับออกจากบันเดิล (#338 · #345) · S-03 ปิดด้วย `card-tile-cv` (ไพ่ครบ 78 ใบใน HTML ตามข้อห้าม SEO แต่ข้ามการวาดนอกจอ — `/cards` TBT ~4,000 ➔ ~100 ms · HANDOFF_CARD_TILE_CV) · _ตรวจ 2026-09-23_ |
