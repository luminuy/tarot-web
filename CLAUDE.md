...
| [docs/plans/HANDOFF_GLASS_HOME_2026-09-21.md](docs/plans/HANDOFF_GLASS_HOME_2026-09-21.md) | 🪟 ✅ **ธีมกระจกอุ่น (Warm Liquid Glass) + หน้าแรก "ประตูเดียว" — ใช้งานจริงครบทั้งเว็บแล้ว** (PR #551 · #552 · #556 · #557 · #560 · #561 · #562) · เจ้าของเคาะแล้วทั้งสองเรื่อง · ได้ลุคกระจกโดย**ไม่ใช้ `backdrop-filter` เลย** (ถูกแบนถาวรจาก INC-0056 — ถอดออกแล้ว fps 30 ➔ 58) · ค่าทุกตัวคัดลอกไปวางได้ทันที · **ตารางคอนทราสต์คำนวณจริงตามสูตร WCAG** จากจุดมืดที่สุดของพื้นหลัง `#DBDCD0` (บนแผงกระจก: ink 13.23 · muted 5.87 · gold-ink 4.96) · กับดักใหญ่สุดคือ**ด่าน a11y อ่านค่าโทเคน ไม่ได้อ่านพิกเซล จึงผ่านเขียวแม้ของจริงตก** · กับดัก 7 ข้อ · เกณฑ์รับงาน 21 ข้อ |
