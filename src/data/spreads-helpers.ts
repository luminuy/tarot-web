 ...
 *
 * ทำไมต้องแยกออกมา: `spreads.ts` เก็บผังทั้ง 26 แบบพร้อมคำอธิบายสองภาษาครบทุกตำแหน่ง
...
export interface Spread {
   ...
   *
   * ⚠️ ห้ามนำไปใช้ใน UI เลือกผังเด็ดขาด เพราะทั้ง 26 ผังขึ้นต้นด้วย
   ...
   * จำนวน "26 ผัง" ที่ประกาศไว้ทั่วเว็บเพี้ยน — ใช้ `PUBLIC_SPREADS` ทุกครั้งที่แสดงรายการ
   */
  internal?: boolean;
}
