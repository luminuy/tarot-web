  ...
  minor: {
    ...
    introContentTh: {
      paragraphs: [
        ...
        "เคล็ดลับสำคัญในการอ่านไพ่ชุดเล็กคือการแยกแยะระหว่างไพ่ตัวเลขกับไพ่ราชสำนัก ไพ่ตัวเลข 1 ถึง 10 จะบอกเล่าถึงพัฒนาการของสถานการณ์ อุปสรรคภายนอก และระดับพลังงานที่กำลังดำเนินไป เช่น การรวมกันของไพ่หมายเลขต้นๆ หมายถึงการเพิ่งเริ่มต้น ในขณะที่ไพ่ราชสำนัก (เด็กรับใช้, อัศวิน, ราชินี, และราชา) มักทำหน้าที่เป็นตัวแทนของบุคคลจริงที่มีอิทธิพลต่อเหตุการณ์ วุฒิภาวะทางอารมณ์ หรือทัศนคติที่ผู้รับคำทำนายจำเป็นต้องดึงมาใช้รับมือ หากเข้าใจจุดเชื่อมโยงนี้ จะช่วยให้การอ่านไพ่ชุดเล็กมีความคมชัดและชี้แนะแนวทางปฏิบัติได้อย่างแม่นยำ",
      ],
      highlights: [
        {
