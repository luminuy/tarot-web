  ...
  major: {
    ...
    introContentTh: {
      paragraphs: [
        ...
        "ในทางจิตวิทยาเชิงลึกตามแนวคิดของ คาร์ล ยุง (Carl Jung) ไพ่ชุดใหญ่สะท้อนภาพแม่แบบจิตใต้สำนึก (Archetypes) ที่มนุษย์ทุกคนต้องเผชิญในชีวิตจริง เป็นการเดินทางที่นักวิชาการเรียกว่า 'The Fool's Journey' ซึ่งเริ่มต้นจากความไร้เดียงสาและการก้าวเดินสู่วิถีใหม่ของ The Fool ผ่านการฝึกฝนเจตจำนงของ The Magician การค้นหาปรีชาญาณภายในกับ The High Priestess จนก้าวผ่านวิกฤติต่าง ๆ เช่น The Tower และจบลงด้วยความตระหนักรู้อันสมบูรณ์ใน The World",
