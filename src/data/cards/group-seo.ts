...
export const CARD_GROUPS: Record<CardGroupInfo["id"], CardGroupInfo> = {
  major: {
    ...
    descriptionEn:
      "All 22 Major Arcana cards explained, from The Fool to The World — upright and reversed meanings and the soul's journey, in original 1909 Rider-Waite art.",
    cardCount: 22,
    ...
    introContentTh: {
      paragraphs: [
        ...
        "ไพ่ชุดใหญ่ 22 ใบเล่าเรื่องช่วงสำคัญที่ทุกคนต้องเจอในชีวิต (นักจิตวิทยา คาร์ล ยุง มองว่าเป็นภาพที่ฝังอยู่ในใจคนทุกยุค) เรียงเป็นการเดินทางที่เรียกว่า 'The Fool's Journey' ซึ่งเริ่มต้นจากความไร้เดียงสาและการก้าวเดินสู่วิถีใหม่ของ The Fool ผ่านการฝึกฝนเจตจำนงของ The Magician การค้นหาปรีชาญาณภายในกับ The High Priestess จนก้าวผ่านวิกฤติต่าง ๆ เช่น The Tower และจบลงด้วยความตระหนักรู้อันสมบูรณ์ใน The World",
        ...
        "เมื่อไพ่ชุดใหญ่ปรากฏขึ้นพร้อมกันหลายใบในผังพยากรณ์เดียวกัน เช่น ในผังเคลติกครอสมีไพ่ชุดใหญ่เกินกว่า 4 ถึง 5 ใบ นั่นคือสัญญาณบ่งบอกว่าช่วงเวลานี้ของชีวิตเต็มไปด้วยพลังงานแห่งโชคชะตาที่ทรงพลังและยากจะหลีกเลี่ยง เป็นจังหวะชีวิตที่จักรวาลกำลังเร่งรัดบทเรียนสำคัญเพื่อให้เกิดการยกระดับจิตวิญญาณ ในทางกลับกัน หากมีไพ่ชุดใหญ่ออกมาเพียงใบเดียวท่ามกลางไพ่ชุดเล็ก ไพ่ใบนั้นจะทำหน้าที่เป็นประภาคารนำทางหรือแก่นหัวใจหลักของคำถาม ในขณะที่ไพ่ชุดเล็กใบอื่นจะช่วยขยายความให้เห็นรายละเอียดและขั้นตอนในการรับมืออย่างเป็นรูปธรรม",
      ],
      highlights: [
        {
    ...
    introContentEn: {
      paragraphs: [
        ...
        "When multiple Major Arcana cards surface within a single spread—such as four or more in a Celtic Cross—it indicates that the querent is immersed in a dense nexus of destiny and monumental life transitions where free will intersects with profound cosmic timing. Conversely, when a solitary Major card appears amidst Minor cards, that single archetype serves as the master lighthouse or spiritual compass for the reading, while surrounding Minor cards detail the practical steps and mundane circumstances required to navigate it.",
      ],
      highlights: [
        {
  ...
  minor: {
    ...
    descriptionEn:
      "All 56 Minor Arcana cards explained — pips and courts across Wands, Cups, Swords, and Pentacles, upright and reversed, for everyday questions.",
    cardCount: 56,
    ...
    introContentTh: {
      paragraphs: [
        ...
        "เคล็ดลับสำคัญในการอ่านไพ่ชุดเล็กคือการแยกแยะระหว่างไพ่ตัวเลขกับไพ่ราชสำนัก ไพ่ตัวเลข 1 ถึง 10 จะบอกเล่าถึงพัฒนาการของสถานการณ์ อุปสรรคภายนอก และระดับพลังงานที่กำลังดำเนินไป เช่น การรวมกันของไพ่หมายเลขต้น ๆ หมายถึงการเพิ่งเริ่มต้น ในขณะที่ไพ่ราชสำนัก (เด็กรับใช้, อัศวิน, ราชินี, และราชา) มักทำหน้าที่เป็นตัวแทนของบุคคลจริงที่มีอิทธิพลต่อเหตุการณ์ วุฒิภาวะทางอารมณ์ หรือทัศนคติที่ผู้รับคำทำนายจำเป็นต้องดึงมาใช้รับมือ หากเข้าใจจุดเชื่อมโยงนี้ จะช่วยให้การอ่านไพ่ชุดเล็กมีความคมชัดและชี้แนะแนวทางปฏิบัติได้อย่างแม่นยำ",
      ],
      highlights: [
        {
    ...
    introContentEn: {
      paragraphs: [
        ...
        "A foundational technique in reading the Minor Arcana lies in discerning the dynamic interplay between the numbered pip cards (Ace through Ten) and the court cards (Page, Knight, Queen, King). While numbered cards chart the situational evolution, outer events, and cyclical progression of circumstances, court cards represent human personalities, emotional maturity levels, specific individuals entering your life, or psychological archetypes you must embody. Mastering this distinction transforms everyday readings from vague descriptions into sharp, actionable strategic counsel.",
      ],
      highlights: [
        {
  ...
  wands: {
    ...
    descriptionTh:
      "เจาะลึกความหมายไพ่ยิปซีดอกไม้เท้าครบ 14 ใบ (Suit of Wands) ธาตุไฟแห่งพลังงาน ความมุ่งมั่น การงาน และแรงบันดาลใจ ทั้งหัวตั้งและกลับหัว",
    seoTitleEn: "Suit of Wands Meanings: All 14 Cards (Element of Fire)",
    descriptionEn:
      "All 14 cards in the Suit of Wands — the element of Fire governing passion, ambition, and creative drive, upright and reversed, from Ace to King.",
    elementTh: "ไฟ",
    elementEn: "Fire",
    cardCount: 14,
    ...
    introContentTh: {
      paragraphs: [
        ...
        "ไพ่ชุดไม้เท้าทำหน้าที่ได้อย่างโดดเด่นเป็นพิเศษเมื่อใช้ตอบคำถามที่เกี่ยวกับความคิดริเริ่มสร้างสรรค์ การเปลี่ยนผ่านในสายอาชีพ การเริ่มต้นทำธุรกิจส่วนตัว หรือเมื่อคุณกำลังเผชิญกับทางแยกของการตัดสินใจที่ต้องอาศัยความกล้าหาญ หากคุณถามว่า 'โปรเจกต์นี้ควรลุยต่อหรือไม่' หรือ 'จะปลุกไฟในการทำงานกลับคืนมาได้อย่างไร' ไพ่ไม้เท้าจะให้คำตอบที่ชี้ชัดถึงระดับความพร้อมของพลังกายและพลังใจ ทั้งยังเตือนให้ระวังการกระจายความสนใจไปหลายทิศทางพร้อมกันจนสูญเสียแรงขับเคลื่อน การอ่านไพ่ไม้เท้าจึงเป็นการตรวจวัดระดับไฟในใจ และวางแผนการจัดสรรพลังงานอย่างชาญฉลาดเพื่อให้เป้าหมายสำเร็จได้อย่างงดงาม",
      ],
      highlights: [
        {
    ...
    introContentEn: {
      paragraphs: [
        ...
        "The Suit of Wands shines with exceptional clarity when answering questions surrounding bold career pivots, creative ventures, entrepreneurial initiatives, and moments demanding raw courage. When inquiring whether a prospective project is worth pursuing or how to rekindle personal motivation, Wands provide an immediate diagnosis of your vital energy, stamina, and creative drive. They prompt you to discern whether your current passion is sustained by disciplined focus or dissipated across too many scattered fronts, empowering you to channel your inner spiritual fire into enduring achievement and meaningful victory.",
      ],
      highlights: [
        {
  ...
  cups: {
    ...
    descriptionTh:
      "เจาะลึกความหมายไพ่ยิปซีดอกถ้วยครบ 14 ใบ (Suit of Cups) ธาตุน้ำแห่งความรัก อารมณ์ ความสัมพันธ์ และสัญชาตญาณ ทั้งหัวตั้งและกลับหัว",
    seoTitleEn: "Suit of Cups Meanings: All 14 Cards (Element of Water)",
    descriptionEn:
      "All 14 cards in the Suit of Cups — the element of Water governing love, emotion, and intuition, upright and reversed, from Ace to King.",
    elementTh: "น้ำ",
    elementEn: "Water",
    cardCount: 14,
    ...
    introContentTh: {
      paragraphs: [
        ...
        "เมื่อไพ่ชุดถ้วยปรากฏในคำถามเกี่ยวกับความรัก หัวใจสำคัญของการพยากรณ์คือการแยกแยะระหว่าง 'อารมณ์ความรู้สึกชั่วคราว' กับ 'สายใยความผูกพันที่แท้จริง' ไพ่ตัวเลขช่วงต้นอย่าง Ace of Cups หรือ Two of Cups บ่งบอกถึงความประทับใจแรกเริ่มและความเสน่หาที่ผลิบาน แต่การก้าวไปสู่ความรักที่มั่นคงยืนยาวจำเป็นต้องอาศัยวุฒิภาวะทางอารมณ์และการเข้าใจตนเองอย่างลึกซึ้งตามแบบฉบับของ Queen of Cups และ King of Cups หากมีไพ่เตือนเรื่องความเฉยชาอย่าง Four of Cups หรือความผิดหวังในอดีตอย่าง Five of Cups ขึ้นมา ไพ่ไม่ได้บอกให้เราหมดหวัง แต่เตือนให้กลับมาโอบกอดและเยียวยาหัวใจของตัวเองให้เปี่ยมล้นเสียก่อน เพื่อให้พร้อมแบ่งปันความรักอันบริสุทธิ์และสร้างความสุขที่แท้จริงร่วมกับผู้อื่นได้อย่างยั่งยืน",
      ],
      highlights: [
        {
    ...
    introContentEn: {
      paragraphs: [
        ...
        "When interpreting the Suit of Cups in matters of the heart, the paramount skill lies in discerning between fleeting emotional infatuation and authentic, soulful devotion. While early pip cards like the Ace of Cups or Two of Cups signal the tender dawn of mutual attraction, cultivating enduring intimacy demands emotional maturity, inner security, and mindful communication exemplified by the Queen and King of Cups. If challenging reflections such as the emotional withdrawal of the Four of Cups or the sorrow of the Five of Cups emerge, they do not herald doom; rather, they gently invite you to heal inward wounds, replenish your own emotional wellspring, and cultivate self-love before seeking genuine, lasting harmony with a partner.",
      ],
      highlights: [
        {
  ...
  swords: {
    ...
    descriptionTh:
      "เจาะลึกความหมายไพ่ยิปซีดอกดาบครบ 14 ใบ (Suit of Swords) ธาตุลมแห่งความคิด สติปัญญา การตัดสินใจ และอุปสรรค ทั้งหัวตั้งและกลับหัว",
    seoTitleEn: "Suit of Swords Meanings: All 14 Cards (Element of Air)",
    descriptionEn:
      "All 14 cards in the Suit of Swords — the element of Air governing intellect, truth, and hard decisions, upright and reversed, from Ace to King.",
    elementTh: "ลม",
    elementEn: "Air",
    cardCount: 14,
    ...
    introContentTh: {
      paragraphs: [
        ...
        "แม้ภาพสัญลักษณ์ของไพ่ชุดดาบมักดูตึงเครียดหรือน่าหวั่นเกรง เช่น คมดาบที่ทิ่มแทงหรือความมืดมิดในยามค่ำคืน แต่แท้จริงแล้วดาบไม่ได้เป็นลางร้าย หากแต่คือ 'ความเมตตาแห่งสัจธรรม' (The Compassion of Truth) ที่เข้ามาตัดภาพลวงตาและความลังเลสงสัยให้หมดสิ้นไป ไพ่อย่าง Three of Swords หรือ Ten of Swords ไม่ได้เกิดขึ้นเพื่อซ้ำเติมความเจ็บปวด แต่กำลังเตือนว่าสิ่งที่ไม่จริงหรือไม่คู่ควรได้จบลงแล้ว เพื่อเปิดทางให้คุณฟื้นฟูจิตใจด้วยความสงบของ Four of Swords และก้าวไปข้างหน้าด้วยวิสัยทัศน์ที่เฉียบคมและสติปัญญาอันบริสุทธิ์ ดาบสอนให้เรากล้าเผชิญหน้ากับความจริง ยอมรับสิ่งที่ไม่อาจเปลี่ยนแปลง และใช้เหตุผลชี้นำชีวิตให้หลุดพ้นจากพันธนาการทางความคิดของตนเอง",
      ],
      highlights: [
        {
    ...
    introContentEn: {
      paragraphs: [
        ...
        "Although the imagery of the Suit of Swords often appears intimidating—marked by piercing blades, storm clouds, and somber nights—these cards are never omens of unmitigated despair. Instead, they represent the fierce compassion of unvarnished truth, slicing away illusions, denial, and debilitating ambivalence. Challenging archetypes like the Three of Swords or Ten of Swords mark the definitive end of painful cycles, releasing you from chronic dread so that healing stillness (Four of Swords) and renewed clarity may emerge. The Swords challenge us to confront reality with unyielding integrity, make courageous rational decisions, and liberate our minds from the self-imposed prisons of anxiety and overthinking.",
      ],
      highlights: [
        {
  ...
  pentacles: {
    ...
    descriptionTh:
      "เจาะลึกความหมายไพ่ยิปซีดอกเหรียญครบ 14 ใบ (Suit of Pentacles) ธาตุดินแห่งการเงิน โชคลาภ ธุรกิจ และความมั่นคง ทั้งหัวตั้งและกลับหัว",
    seoTitleEn: "Suit of Pentacles Meanings: All 14 Cards (Element of Earth)",
    descriptionEn:
      "All 14 cards in the Suit of Pentacles — the element of Earth governing money, work, and material stability, upright and reversed, from Ace to King.",
    elementTh: "ดิน",
    elementEn: "Earth",
    cardCount: 14,
    ...
    introContentTh: {
      paragraphs: [
        ...
        "ไพ่เหรียญคือตัวแทนของความอดทน การลงแรง และการสั่งสมความสำเร็จอย่างเป็นขั้นเป็นตอน ไพ่ชุดนี้จะปรากฏขึ้นเสมอเมื่อคำถามเกี่ยวข้องกับการลงทุน การซื้อขายอสังหาริมทรัพย์ สถานะทางการเงิน ความปลอดภัยในอาชีพการงาน หรือผลตอบแทนจากการทุ่มเททำงานหนัก แสดงตั้งแต่โอกาสทางการเงินใหม่ ๆ (Ace of Pentacles), ทักษะความเชี่ยวชาญระดับมืออาชีพ (Eight of Pentacles), ไปจนถึงมรดกและความมั่งคั่งที่ยั่งยืน (Ten of Pentacles)",
        ...
        "ลักษณะเด่นที่สุดของไพ่ชุดเหรียญคือ 'มิติด้านกาลเวลา' (The Dimension of Time) ผลลัพธ์และโชคลาภของธาตุดินมักไม่ปรากฏแบบฉับพลันชั่วข้ามคืนเหมือนแรงผลักดันของไม้เท้า หรือเปลี่ยนแปลงรวดเร็วตามอารมณ์เหมือนถ้วย หากแต่ดำเนินไปตามกฎธรรมชาติที่ต้องอาศัยการหว่านเมล็ด การรดน้ำพรวนดิน และความอดทนรอคอยอย่างสม่ำเสมอเฉกเช่น Seven of Pentacles และ Eight of Pentacles การที่ไพ่เหรียญปรากฏในผังพยากรณ์จึงเป็นเครื่องยืนยันว่า แม้ความก้าวหน้าอาจดูเหมือนเชื่องช้า แต่มันกำลังหยั่งรากลึกและเติบโตอย่างมั่นคงที่สุด เป็นความสำเร็จที่จับต้องได้และไม่มีสิ่งใดโค่นล้มได้ง่าย ซึ่งจะนำพาไปสู่ความมั่งคั่งที่ยั่งยืนและความสมบูรณ์พูนสุขในระยะยาว",
      ],
      highlights: [
        {
    ...
    introContentEn: {
      paragraphs: [
        ...
        "A defining attribute of the Suit of Pentacles is its relationship with sacred time and physical gestation. Unlike the sudden flashes of inspiration in Wands or the swift emotional currents of Cups, the blessings of Earth unfold through patient cultivation, methodical persistence, and steadfast discipline, as mirrored in the Seven and Eight of Pentacles. When Pentacles appear in your reading, they serve as a grounding reassurance: while progress may seem deliberate and slow, it is forging immovable foundations. What is built with integrity, craft, and sustained effort will endure against worldly storms, blossoming into generational wealth, physical vitality, and tangible peace.",
      ],
      highlights: [
        {
