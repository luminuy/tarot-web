...
const base =
  "w-full rounded-lg bg-[#FFFFFF] border border-[#E4D8C4] px-3.5 py-2.5 text-sm text-[#2E211A] " +
  "placeholder:text-[#6F5B4A]/60 transition-colors duration-[var(--dur-fast)] " +
  "focus-visible:outline-none focus-visible:border-[#E4D8C4] focus-visible:ring-2 focus-visible:ring-[#8F5C1A]/30 shadow-xs " +
