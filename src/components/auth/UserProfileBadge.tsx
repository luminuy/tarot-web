          ...
          >
            ...
            <div className="pt-1 border-t border-[#e5c07b]/15">
              <button
                ...
                className="w-full text-left p-2.5 rounded-2xl text-rose-400 hover:text-rose-200 hover:bg-rose-950/40 border border-transparent hover:border-rose-500/30 transition-all cursor-pointer flex items-center justify-between group active:scale-98"
              >
