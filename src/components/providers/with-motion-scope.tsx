 ...
 *
 * ⚠️ **ห่อเฉพาะคอมโพเนนต์ที่ `import` จาก `motion/react` จริง ๆ เท่านั้น** (INC-0137)
 *    ห่อตัวที่ไม่ได้ใช้ = พ่วงไลบรารี 40 KB (รวมสองก้อน 68.7 KB) ไว้ใน chunk เดียวกัน
 *    ผู้ใช้ที่กดเปิดต้องรอโหลด+คอมไพล์ของที่ไม่มีใครเรียก บนมือถือเห็นเป็น
 *    "แตะแล้วจอนิ่งไปครู่หนึ่ง แล้วเด้งขึ้นมาแบบกระพริบ" · ด่านกฎ 13 ใน
 *    `scripts/qa/test-motion-quality.ts` ตรวจข้อนี้ให้แล้ว
 *
