  ...
  return (
    <div className="space-y-6 w-full">
      ...
      */}
      ...
      <div className="flex sm:hidden items-center justify-between px-1 text-[11px] text-[#e5c07b]/90 font-serif-th select-none -mb-2">
        <span className="flex items-center gap-1.5">
          <span>✦</span>
          <span>ปัดซ้าย-ขวาเพื่อเลือกผัง ({filteredSpreads.length} ผัง)</span>
        </span>
        <span className="text-[10px] text-[#9c93b8] font-mono tracking-wider">
          ← เลื่อน →
        </span>
      </div>
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="flex flex-row overflow-x-auto snap-x snap-mandatory gap-4 pb-4 pt-1 px-4 -mx-4 no-scrollbar sm:grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 sm:gap-5 sm:mx-0 sm:px-0 sm:pb-0 sm:pt-0 sm:overflow-visible"
        >
