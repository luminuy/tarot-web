 ...
 *    จึงเป็นลิงก์ธรรมดาไปหน้า `/account` ซึ่งมีปุ่มเข้าสู่ระบบ/สมัครสมาชิกให้คนที่ยังไม่ล็อกอินอยู่แล้ว
 *    · ไม่มี JS · ไม่ยิง API · จุดทอง "ล็อกอินอยู่" เปิดด้วยสคริปต์หัวเว็บจากคุกกี้ใบ้ของเซสชัน
