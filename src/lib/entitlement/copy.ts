...
export const UPGRADE_COPY: Record<UpgradeReason, UpgradeCopy> = {
  ...
  grand_spread: {
    ...
    reassurance: "รอบที่เติมไว้ไม่มีวันหมดอายุ · ปลดล็อกผังใหญ่ครบ 26 ผัง + คุยเจาะลึกไม่จำกัด",
  },
  master_persona: {
...
export const UPGRADE_COPY_EN: Record<UpgradeReason, UpgradeCopy> = {
  ...
  grand_spread: {
    ...
    reassurance: "Credits never expire · Unlocks all 26 spreads + unlimited consultation dialogue",
  },
  master_persona: {
