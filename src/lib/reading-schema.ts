...
export const ReadingSchema = z.object({
  ...
  yesNoAnswer: z
    ...
    .nullable()
    .describe("ใส่ค่าเฉพาะเมื่อโหมดใช่/ไม่ใช่ถูกเปิด นอกนั้นให้เป็น null"),
  mood: z
