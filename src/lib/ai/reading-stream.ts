 ...
 * พอจะเพิ่มผู้ให้บริการรายที่สอง (Cerebras) ทางเลือกมีแค่
 *   (ก) ก๊อปโค้ด 200 บรรทัดนี้ไปไว้อีกไฟล์  หรือ
 *   (ข) ยกออกมาไว้ตรงกลางแล้วให้ทั้งสองเจ้าเรียกใช้
 *
 * เลือก (ข) เพราะ (ก) แปลว่าบั๊กภาษาไทยหรือด่านความสอดคล้องทุกตัวในอนาคต
 * ต้องไปแก้สองที่ **และถ้าลืมแก้ที่ใดที่หนึ่งจะไม่มีใครรู้เลย** —
 * ตรงกับสิ่งที่ CLAUDE.md เรียกว่า "ทำผิดซ้ำ = บกพร่องร้ายแรงสุด"
 *
 * ⚠️ ไฟล์นี้ **ไม่รู้จักผู้ให้บริการรายไหนเลย** ห้ามใส่ชื่อ Groq/Cerebras/Gemini
