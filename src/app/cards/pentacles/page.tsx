...
const group = CARD_GROUPS.pentacles;

export const metadata: Metadata = {
  title: group.seoTitleTh,
  description: group.descriptionTh,
  alternates: buildAlternates("/cards/pentacles"),
  openGraph: {
    title: group.seoTitleTh,
    description: group.descriptionTh,
    url: `${SITE_ORIGIN}/cards/pentacles`,
    siteName: "SeerTarot",
    type: "website",
...
export default function PentaclesPage() {
  const cards = DECK_SUMMARY.filter((c) => c.suit === "pentacles");
