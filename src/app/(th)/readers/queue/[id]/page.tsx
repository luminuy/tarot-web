...
export default function CustomerQueuePage() {
  ...
  if (loading && !data) {
    return (
      <main className="min-h-[70vh] bg-[#F6F1E9] text-[#2E211A] flex items-center justify-center p-4">
  ...
  return (
    <main className="min-h-[70vh] bg-[#F6F1E9] text-[#2E211A] p-4 sm:p-8 font-sans relative overflow-hidden flex items-center justify-center">
