      ...
      <div className="max-w-3xl mx-auto px-6 py-16 space-y-10">
        ...
        <section className="space-y-3">
          ...
          <ul className="space-y-2 text-sm text-ink list-disc list-inside leading-relaxed font-serif-th">
            ...
            <li>
              <strong>ราศีของคุณ (ไม่บังคับ)</strong> — เมื่อคุณกด &quot;ให้แม่หมอจำราศีของฉัน&quot; ในหน้าไพ่ประจำราศี
              เราเก็บเฉพาะชื่อราศีไว้ในเบราว์เซอร์ของคุณ และส่งไปพร้อมคำขอเปิดไพ่เพื่อให้แม่หมอทักเมื่อไพ่ประจำราศีของคุณโผล่
              ไม่มีการส่งหรือเก็บวันเกิด และลบได้ทุกเมื่อจากหน้าเดียวกัน
            </li>
            <li>
